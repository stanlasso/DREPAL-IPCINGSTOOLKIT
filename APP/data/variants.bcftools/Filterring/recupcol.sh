...
do
    ...
    awk '{print $NF}' APP/data/variants.bcftools/Filterring/"$prefix"_comp.tsv >> APP/data/variants.bcftools/Filterring/"$prefix"_alt.tsv
    sleep 0.2
    Id="1i$prefix"
    sed -i $Id APP/data/variants.bcftools/Filterring/"$prefix"_alt.tsv

done

sleep 0.5

paste APP/data/variants.bcftools/Filterring/Chromosones.tsv APP/data/variants.bcftools/Filterring/Positions.tsv APP/data/variants.bcftools/Filterring/References.tsv APP/data/variants.bcftools/Filterring/*_alt.tsv >> APP/data/variants.bcftools/Filterring/MATRICE/MATRICE.tsv
